 ...
 */
function verify( message, dkimKeyRetriever, callback ) {
  ...
  function verifyNextSignature() {
    ...
    DKIM.verifySignature( body, headers, dkimKeyRetriever, function( error, result ) {
...
verify.filterSignatureHeaders = function filterSignatureHeaders(headers, signatureHeader) {
  return headers.filter( function( header ) {
    return !/^(DKIM-Signature)/i.test( header )
